            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Edit Package : {{$packageInfo->title}}</h5>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Edit Package : {{$packageInfo->title}}</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-12 p-0">
        <div class="card">
            <div class="card-header pb-0">
                <div class="row">
                    <div class="col-md-6">
                        <h5 style="padding-top:10px;">Edit Package : {{$packageInfo->title}}</h5>
                    </div>
            ...
            <div class="card-body">
                ...
                {{ Form::open(array('url' => 'admin/packages/update' , 'autocomplete'=>'off', 'enctype' =>'multipart/form-data')) }}
                    <input type="hidden" value="{{encrypt($packageInfo->id)}}" name="id"/>
                    <div class="form-row mt-4">                        
                        <div class="form-group col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" required="" name="title" value="{{$packageInfo->title}}" aria-label="" aria-describedby="basic-addon1">
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control allow_number_decimal" required name="price" value="{{$packageInfo->price}}" aria-label="" aria-describedby="basic-addon1">
                        ...
                        @if(count($features)>0)                            
                            @foreach($features as $feature)                           
                                <div class="custom-control custom-checkbox w-100">
                                    <input type="checkbox" name="features[]" value="{{$feature->id}}" class="custom-control-input" {{in_array($feature->id, unserialize($packageInfo->features)) ? 'checked' : ''}} id="checked{{$feature->id}}">
