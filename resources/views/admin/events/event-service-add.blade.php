            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Events Add Services</h5>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Events Add Service</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-12 p-0">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h5 style="padding-top:10px;">Add New Service</h5>
                    </div>
            ...
            <div class="card-body">
                ...
                {{ Form::open(array('url' => 'admin/event/sevices/add' , 'autocomplete'=>'off', 'enctype' =>'multipart/form-data')) }}
